							...
							<c:choose>
								...
								<c:otherwise>
									...
									<a title="${seeOnMap}" class="font-sans font-bold pr-3 mt-1 justify-center flex flex-row" href="https://www.google.com/maps/search/?api=1&query=${param.location}" target="_blank">
										<h1 class="font-sans font-bold mt-2 text-blue-500 underline"><messages:message code="Location.${param.location}"/></h1>
										<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="#3b82f6" stroke-width="2">
