...
<div class="bg-white shadow rounded-lg py-1">
    <div class="flex flex-col">
        <div class="flex flex-col gap-1 items-center">
            <img class="h-32 w-32 bg-white p-2 rounded-full shadow mb-4" src="<c:url value="/profilepic/${param.username}"/>" alt="">
            <p class="font-semibold">${param.username}</p>
        </div>
