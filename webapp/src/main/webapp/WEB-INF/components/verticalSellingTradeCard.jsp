...
<div class="bg-[#FAFCFF] p-[50px] shadow-xl flex flex-col rounded-lg justify-between my-5 mx-5">
...
<%--        </div>--%>
<%--    </div>--%>
    <div class="flex flex font-sans my-3 mx-auto text-semibold">
        <h1> 150 DAI ⟶ 3000<c:out value="${param.quantity}"/>$ARS</h1>
    </div>

    <div class="flex flex-col m-10 px-5 py-3 rounded-lg bg-stormd/[0.9] border-2 border-polard h-4/5">
