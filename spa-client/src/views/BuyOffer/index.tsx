...
const BuyOffer = () => {
    ...
    async function  retrieveOfferInformation(offerId:number){
        try{
            ...
            else toast.error(i18n.t('connectionError')+ i18n.t('failedToFetch') + i18n.t('offers'));
        }
        ...
        <div className="flex flex-wrap mt-10 mx-5">
            <div className="flex flex-col w-3/5 shadow rounded-lg bg-white">
                ...
                <form className="flex flex-col mt-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input type="number" step="0.000000000000001" className="p-2 m-2 rounded-lg shadow mx-auto" placeholder={i18n.t('AmountInCrypto')!}  onChange={(e)=>fillARS(e)} id={"crypto_amount"}/>
