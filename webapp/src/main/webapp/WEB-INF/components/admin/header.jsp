...
<nav class="w-60 bg-frostdr h-full flex flex-col fixed">
    ...
    <ol class="flex flex-col divide-y mt-10">
        <li></li>
        <a class="flex py-10 flex-col ${param.active == 'complaints'? 'font-extrabold text-xl': ' ' }" href="<c:url value="/admin"/>">
        <li>
               <svg xmlns="http://www.w3.org/2000/svg" class="${param.active == 'complaints'? 'h-12 w-12 mx-auto font-extrabold': 'h-10 w-10 mx-auto'}" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="2">
        ...
        <a class="flex flex-col flex py-10 ${param.active == 'kycAll'? 'font-extrabold text-xl': ' ' }" href="<c:url value="/admin/kyccheck"/>">
            <li>
                <svg xmlns="http://www.w3.org/2000/svg" class="${param.active == 'kycAll'? 'h-12 w-12 mx-auto font-extrabold': 'h-10 w-10 mx-auto'}" fill="none" viewBox="0 0 24 24" stroke="white" stroke-width="1">
