...
public class TradeCompleteTest {
    ...
    public void getTradeById(){
        ...
        //Execute
        Optional<Trade> testedTrade = tradeHibernateDao.getTradeById(tradeId);
    ...
    public void getAllTradesByUsername(){
        ...
        Collection<Trade> testedTrades = tradeHibernateDao.getTradesByUsername(username, 0, rows);
    ...
    public void getTradesByUsernameCountTest(){
        ...
        // Execute
        int testedCount = tradeHibernateDao.getTradesByUsernameCount("gbeade");
