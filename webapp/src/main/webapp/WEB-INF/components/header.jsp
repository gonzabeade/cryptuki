    ...
    <div class="container flex flex-wrap mx-auto my-auto px-[10%] h-full justify-between">
        ...
        <div class="flex justify-end">
            <ol class="flex mt-4">
                ...
                <li>
                    <a href="<c:url value="/coins"/>" class="py-2 pr-4 pl-3 text-polar text-xl font-bold hover:underline hover:decoration-frostdr hover:underline-offset-8">Monedas</a>
                </li>
                <li>
                    <a href="<c:url value="/contact"/>" class="py-2 pr-4 pl-3 text-polar font-bold text-xl hover:underline hover:decoration-frostdr hover:underline-offset-8 ">Contactate</a>
                </li>
            </ol>
        </div>
    </div>
