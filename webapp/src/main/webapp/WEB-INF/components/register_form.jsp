...
<form:form modelAttribute="registerForm" action="${postPath}" method="post" cssClass=" py-12 px-36 rounded-lg bg-stormd/[0.9] flex flex-col justify-center mx-auto border-2 border-polard">
    ...
    <div class="flex flex-col mt-3">
        ...
        <form:input type="text" path="phoneNumber" cssClass="rounded-lg p-3"/>
    ...
    <div class="flex flex-col mt-3">
        ...
        <form:input type="password" path="password" cssClass="rounded-lg p-3" />
    ...
    <div class="flex flex-col mt-3">
        ...
        <form:input type="password" path="repeatPassword" cssClass="rounded-lg p-3"/>
