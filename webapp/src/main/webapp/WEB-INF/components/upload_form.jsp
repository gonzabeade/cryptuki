...
<div class="flex flex-col">
    <form:form modelAttribute="uploadOfferForm" action="/upload" method="post" class="flex flex-col min-w-[50%]">
        ...
        <div class="flex flex-col justify-center my-9">
            <form:errors path="maxAmount" cssClass=" mx-auto text-red-500"/>
            <form:label  path="maxAmount" class="text-xl font-sans text-polard font-semibold mb-3 text-center">¿Cuánto es el maximo de MONEDA que quieres vender?*</form:label>
        ...
        <div class="flex flex-col justify-center my-9">
            ...
            <form:label  path="minAmount" class="text-xl font-sans text-polard font-semibold mb-3 text-center">¿Cuánto es el minimo de MONEDA que quieres vender?*</form:label>
            <div class="flex flex-row justify-center mx-auto">
                <form:input type="number" path="minAmount" class="h-10 justify-center rounded-lg p-3 mx-5"/>
                <!-- <h1 class="my-auto" id="coinAmount">~0.00000</h1> -->
            </div>
        </div>

        <div class="flex flex-col my-9 mx-auto">
            ...
            <div class="flex flex-row justify-center mx-80">
                <c:forEach items="${cryptocurrencies}" var="paymentMethod">
                    <form:checkbox path="paymentMethods" value="${paymentMethod.code}" cssClass="my-auto font-sans scale-150"/>
                    <form:label path="paymentMethods" cssClass="mr-4 ml-2 my-auto"><c:out value="${paymentMethod.name}"/></form:label>
                </c:forEach>
            </div>
        </div>
