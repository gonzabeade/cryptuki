...
<div class=" p-12 mx-32 rounded-lg bg-stormd/[0.9] flex  justify-center border-2 border-polard flex flex-col">
  <div class="flex flex-col height-auto mx-auto">
        ...
        <div class="group flex flex-col">
          <form:label path="multipartFile">
            <div class="flex flex-col mx-auto">
              <img src="<c:url value="/profilepic/${username}"/>"  class=" shadow rounded-full w-36 object-cover mx-auto group-hover:bg-gray-400" >
  ...
  <div class="flex flex-col">
    <div class="flex justify-between rounded-lg h-12 mb-5 mt-5 mr-5 mx-10">
      <div class="flex basis-1/2 items-center justify-center ">
        <h2 class="text-2xl font-semibold font-sans text-polar text-left" >Correo electronico: </h2>
      </div>
      <div class="flex items-center justify-center basis-1/2">
        <h2 class="text-lg font-semibold font-sans text-polar text-left"><c:out value="${user.email}"/></h2>
      </div>
    </div>
    <div class="flex justify-between rounded-lg h-12 mb-5 mt-5 mr-5 mx-10">
      <div class="flex basis-1/2 items-center justify-center ">
        <h2 class="text-2xl font-semibold font-sans text-polar text-left" >Teléfono : </h2>
      </div>
      <div class="flex items-center justify-center basis-1/2">
        <h2 class="text-lg font-semibold font-sans text-polar"><c:out value="${user.phoneNumber}"/></h2>
      </div>
    </div>
    <div class="flex justify-between rounded-lg h-12 mb-5  mt-5 mr-5 mx-10">
      <div class="flex basis-1/2 items-center justify-center  justify-center ">
        <h2 class="text-2xl font-semibold font-sans text-polar text-left">Cantidad de trades:</h2>
      </div>
      <div class="flex items-center justify-center basis-1/2">
        <h2 class="text-xl font-semibold font-sans text-polar"><c:out value="${user.ratingCount}"/></h2>
      </div>
    </div>
