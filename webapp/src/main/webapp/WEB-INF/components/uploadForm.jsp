    ...
    <form:form modelAttribute="uploadOfferForm" action="${postUrl}" method="post" class="flex flex-col min-w-[50%]">
        <div class="flex flex-row divide-x">
            <div class="flex flex-col">
                <h1 class="font-sans font-polard font-extrabold text-2xl text-center">Price Settings</h1>
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <form:label  path="cryptoCode" class="text-xl font-sans text-polard  mb-3 text-center"><messages:message code="cryptocurrency"/>*</form:label>
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <form:label path="unitPrice" class="text-xl font-sans text-polard  mb-3 text-center "><messages:message code="priceByCurrency"/> ARS*</form:label>
                    <div class="flex flex-col justify-center ">
                ...
                <div class="flex flex-col justify-center mt-4">
                    <h2 class="text-xl font-sans text-polard mb-3 text-center flex flex-row justify-center "><messages:message code="limits"/>*</h2>
                    ...
                    <div class="flex flex-row justify-center">
                        <div>
                            <form:label  path="minInCrypto" class="text-lg font-sans text-polard mb-3 text-center flex flex-row justify-center "><messages:message code="minIn"/> <p id="minCoin" class="mx-2">BTC</p></form:label>
                            <div class="flex flex-row justify-center mx-auto">
                        ...
                        <div>
                            <form:label  path="maxInCrypto" class="text-lg font-sans text-polard mb-3 text-center flex flex-row justify-center"><messages:message code="maxIn"/><p id="maxCoin" class="mx-2">BTC</p></form:label>
                            <div class="flex flex-row justify-center mx-auto">
            ...
            <div class="flex flex-col mx-auto w-96 ">
                ...
                <form:label path="location"
                            class="text-2xl font-sans text-polard font-extrabold mb-3 text-center "><messages:message
                ...
                <div class="flex flex-col justify-center px-5">
                    ...
                    <h2 class="text-xl font-sans text-polard text-center flex flex-row justify-center mt-3">Hood*</h2>
            ...
            <div class="flex flex-col px-10">
                <form:label path="firstChat"
                            class="text-xl font-sans text-polard font-semibold mb-3 text-center "><messages:message
        ...
        <div class="flex flex-row p-5 mx-60 mt-10">
            <a class="bg-polarlr/[0.6] text-white text-center mt-4 p-3 rounded-md font-sans min-w-[25%] mx-auto"
               href="javascript:history.back()"><messages:message code="cancel"/></a>
            <button type="submit"
                    class="bg-frostdr text-white  mt-4 p-3 rounded-md font-sans min-w-[25%] mx-auto active:cursor-progress">
